...
public class verProgresoOlimpiada extends AppCompatActivity {

    private static final String TAG = "verProgresoOlimpiada";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_progreso_olimpiada);
    ...
    private void fetchExamenes() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    String totalPreguntas = exam.getString("total_preguntas");
                                    String aciertos = exam.getString("correctas_general");
                                    String calificacion = exam.getString("puntaje_general");

                                    TableRow tableRow = new TableRow(verProgresoOlimpiada.this);
                                    tableRow.addView(createTextView(fecha));
                                    tableRow.addView(createTextView(totalPreguntas));
                                    tableRow.addView(createTextView(aciertos));
                                ...
                                Toast.makeText(verProgresoOlimpiada.this, message, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException | java.text.ParseException e) {
                            e.printStackTrace();
                            Log.e(TAG, "Error al procesar la respuesta JSON: " + e.getMessage());
                            Toast.makeText(verProgresoOlimpiada.this, "Error en la respuesta del servidor", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(verProgresoOlimpiada.this, "Error al cargar exámenes", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setupLineChart(List<Entry> entries) {
        ...
        LineDataSet dataSet = new LineDataSet(entries, "Puntaje General");
        dataSet.setColor(Color.rgb(239, 214, 248));
        dataSet.setValueTextColor(Color.BLACK);
        dataSet.setLineWidth(2f);
        dataSet.setCircleColor(Color.rgb(239, 214, 248));
