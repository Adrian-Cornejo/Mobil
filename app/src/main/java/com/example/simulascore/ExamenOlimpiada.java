...
public class ExamenOlimpiada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_examenolimpiada);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQuestionIndex < questionListFCE.size() - 1) {
                    ...
                    Toast.makeText(ExamenOlimpiada.this, "Has completado todas las preguntas", Toast.LENGTH_SHORT).show();
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentQuestionIndex > 0) {
                    ...
                    Toast.makeText(ExamenOlimpiada.this, "Estás en la primera pregunta", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (areAllQuestionsAnswered()) {
                    Toast.makeText(ExamenOlimpiada.this, "Examen enviado", Toast.LENGTH_SHORT).show();
                    sendAllAnswers();
                      sendUserAnswersToServer();
                } else {
                    Toast.makeText(ExamenOlimpiada.this, "Por favor, responda todas las preguntas antes de enviar el examen.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void fetchQuestions() {
        ...
        String url = "https://simulascore.com/apis/moduloExamenes/examenOlimpiadas/obtenerPreguntasOlimpiada.php?email=" + email;
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                              ...
                              fetchSavedAnswers(); // Llamar a fetchSavedAnswers() después de que las preguntas se hayan cargado
                                ...
                                Toast.makeText(ExamenOlimpiada.this, message, Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (errorMessage.length() > 100) {
                                errorMessage = errorMessage.substring(0, 100) + "..."; // Truncate if too long
                            }
                            Toast.makeText(ExamenOlimpiada.this, "Error en la respuesta del servidor: " + errorMessage, Toast.LENGTH_LONG).show();   }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(ExamenOlimpiada.this, "Error al cargar preguntas", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void fetchSavedAnswers() {
        String url = "https://simulascore.com/apis/moduloExamenes/examenOlimpiadas/getSavedAnswersOlimpiada.php?email=" + email;
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ExamenOlimpiada.this, "Error en la respuesta del servidorqqq", Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ExamenOlimpiada.this, "Error al cargar respuestas guardadas: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void sendUserAnswersToServer() {
        String url = "https://simulascore.com/apis/moduloExamenes/examenOlimpiadas/guardarRespuestasOlimpiada.php";
    ...
    private void sendAllAnswers() {
        String url = "https://simulascore.com/apis/moduloExamenes/examenOlimpiadas/finalizarExamenOlimpiada.php";
