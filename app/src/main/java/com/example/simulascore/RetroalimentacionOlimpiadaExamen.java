...
public class RetroalimentacionOlimpiadaExamen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (email == null || examId == null) {
            Toast.makeText(this, "Faltan datos necesarios. Por favor, inicie sesión de nuevo.", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentQuestionIndex < questionList.size() - 1) {
                    ...
                    Toast.makeText(RetroalimentacionOlimpiadaExamen.this, "Has completado todas las preguntas", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentQuestionIndex > 0) {
                    ...
                    Toast.makeText(RetroalimentacionOlimpiadaExamen.this, "Estás en la primera pregunta", Toast.LENGTH_SHORT).show();
                }
            }
        });
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RetroalimentacionOlimpiadaExamen.this, home.class);
    ...
    private void fetchQuestionsAndAnswers() {
        ...
        String url = "https://simulascore.com/apis/moduloExamenes/examenOlimpiadas/obtenerPreguntasYRespuestasOlimpiada.php?idExamen=" + examId;
        StringRequest request = new StringRequest(Request.Method.GET, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                JSONArray preguntasAlumno = preguntasAlumnoObj.getJSONArray("Olimpiada");
                                ...
                                Toast.makeText(RetroalimentacionOlimpiadaExamen.this, message, Toast.LENGTH_SHORT).show();
                            }
                            ...
                            Toast.makeText(RetroalimentacionOlimpiadaExamen.this, "Error en la respuesta del servidor: " + errorMessage, Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(RetroalimentacionOlimpiadaExamen.this, "Error al cargar preguntas", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void fetchStudentInfoAndGrade() {
        ...
        String url = "https://simulascore.com/apis/moduloExamenes/examenOlimpiadas/obtenerDatosAlumnoYCalificacion.php?email=" + email + "&idExamen=" + examId;
        StringRequest request = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                if (resultados.length() > 0) {
                                    ...
                                    Toast.makeText(RetroalimentacionOlimpiadaExamen.this, "No se encontraron calificaciones para este examen.", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                String message = jsonResponse.getString("message");
                                Toast.makeText(RetroalimentacionOlimpiadaExamen.this, message, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(RetroalimentacionOlimpiadaExamen.this, "Error al cargar datos del alumno", Toast.LENGTH_SHORT).show();
            }
        });
