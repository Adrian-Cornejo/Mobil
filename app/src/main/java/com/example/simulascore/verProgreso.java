    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(verProgreso.this, home.class);
    ...
    private void fetchExamenes() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    String espanol = exam.getString("calificacionEspanol");
                                    String matematicas = exam.getString("calificacionMatematicas");
                                    String fce = exam.getString("calificacionFce");
                                    String calificacion = exam.getString("puntaje_general");

                                    TableRow tableRow = new TableRow(verProgreso.this);
                                    tableRow.addView(createTextView(fecha));
                                    tableRow.addView(createTextView(espanol));
                                    tableRow.addView(createTextView(matematicas));
                                    tableRow.addView(createTextView(fce));
                                ...
                                Toast.makeText(verProgreso.this, message, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException | java.text.ParseException e) {
                            e.printStackTrace();
                            Log.e(TAG, "Error al procesar la respuesta JSON: " + e.getMessage());
                            Toast.makeText(verProgreso.this, "Error en la respuesta del servidor", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(verProgreso.this, "Error al cargar exámenes", Toast.LENGTH_SHORT).show();
            }
        });
